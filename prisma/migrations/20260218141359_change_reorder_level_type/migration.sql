/*
  ...
  - You are about to alter the column `reorderLevel` on the `Product` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Decimal`.
