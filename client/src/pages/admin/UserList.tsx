        ...
        <div className="p-6 max-w-7xl mx-auto transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredUsers?.map(user => (
                    <div key={user.id || user.user_id} className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm flex flex-col items-center text-center transition-colors">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-1">{user.username || user.name}</h3>
