    ...
    return (
        <div className="border border-border rounded-lg mb-4 overflow-hidden">
            <button
                ...
                className="w-full flex items-center justify-between p-4 bg-card text-card-foreground hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors"
            >
            ...
            {isOpen && (
                <div className="p-4 bg-muted/50 border-t border-border text-gray-700 dark:text-gray-300 space-y-4">
                    {children}
                </div>
            )}
        </div>
...
export const HelpPage = () => {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8">Guide to using the {APP_CONFIG.appName} features and modules.</p>

            <Section title="POS Terminal & Sales" icon={ShoppingCart} defaultOpen={true}>
                <h3 className="font-bold text-foreground mt-2">Processing a Sale</h3>
                ...
                <h3 className="font-bold text-foreground mt-4">Advanced Cart Actions</h3>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <h3 className="font-bold text-foreground mt-4">Returns & Refunds</h3>
                <ul className="list-disc pl-5 space-y-1">
            ...
            <Section title="Inventory Management" icon={Package}>
                <h3 className="font-bold text-foreground mt-2">Managing Products</h3>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <h3 className="font-bold text-foreground mt-4">Stock Control</h3>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <h3 className="font-bold text-foreground mt-4">Categories</h3>
                <ul className="list-disc pl-5 space-y-1">
            ...
            <Section title="Purchasing & Suppliers" icon={Truck}>
                <h3 className="font-bold text-foreground mt-2">Supplier Management</h3>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <h3 className="font-bold text-foreground mt-4">Purchase History</h3>
                <ul className="list-disc pl-5 space-y-1">
            ...
            <Section title="Receipts & Configuration" icon={Settings}>
                <h3 className="font-bold text-foreground mt-2">Currency</h3>
                <ul className="list-disc pl-5 space-y-1">
                    <li>Go to <b>Settings → Currency</b>.</li>
                    <li>Set the symbol and code used across the system.</li>
                </ul>

                <h3 className="font-bold text-foreground mt-4">Branding</h3>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <h3 className="font-bold text-foreground mt-2">Tax Settings</h3>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <h3 className="font-bold text-foreground mt-4">Receipt Customization</h3>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <h3 className="font-bold text-foreground mt-4">Digital Receipts</h3>
                <ul className="list-disc pl-5 space-y-1">
            ...
            <Section title="Reports & Reporting" icon={FileText}>
                <h3 className="font-bold text-foreground mt-2">Centralized Reports</h3>
                <ul className="list-disc pl-5 space-y-1">
                ...
                <h3 className="font-bold text-foreground mt-2">Transaction History</h3>
                <ul className="list-disc pl-5 space-y-1">
